...
- 统一观察25个标的：23个A股ETF/指数专题、2个港股消费QDII专题
- 新增通信ETF（515880.SH，跟踪931160.CSI）与电力ETF（159611.SZ，跟踪H30199.CSI）
- 三层策略：低位收敛、带量突破年线、权重龙头确认
- 独立均线生命周期：MA20转暖、MA60初始启动、MA250当日趋势确认；只输出外部监测接口，不执行交易
