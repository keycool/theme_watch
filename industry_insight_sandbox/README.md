...
1. 低位形成收敛结构，四项标准必须同时满足：
   - 距近 120 日高点不高于 `-15%`
   - 后 40 日波动区间 / 前 80 日波动区间不高于 `0.90`
   - 近 40 日低点 / 近 120 日低点不低于 `1.02`
   - 近 120 日相对沪深 300 超额收益不高于 `-5%`
2. 跟踪指数站上 MA60 且不超过 20 个交易日时触发提前预警；放量站上
   MA250 3%、连续两日收于 MA250 上方，才算正式突破年线。
3. 前 10 大权重股任一只近 20 日涨停即提示；第 4 至 10 名属于渐进预警，
   前 3 权重龙头涨停且次日继续收红，才算严格龙头确认。
